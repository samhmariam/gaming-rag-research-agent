...
from lib.messages import AIMessage, UserMessage, SystemMessage, ToolMessage, AnyMessage
    ...
    def _tool_step(self, state: AgentState) -> AgentState:
        ...
        for call in tool_calls:
            ...
            if tool:
                ...
                # Ensure tool content is a plain string (JSON-encoded only if needed)
                if isinstance(raw_result, str):
                    result_content = raw_result
                else:
                    # Safely JSON-encode non-string results
